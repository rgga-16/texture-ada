...
Author: rohitrango
Date: August 12, 2020
Code version: commit 2404367110956323430613407495396da3eb1c0c
Availability: https://github.com/rohitrango/Image-Quilting-for-Texture-Synthesis 
'''
...
def image_quilting(image_path,output_path,output_size,block_size,
                    overlap,tolerance,num_outputs=1,do_plot=False):
    if overlap > 0:
    ...
    for i in range(num_outputs):
        ...
        if num_outputs == 1:
            ...
            cv2.imwrite(output_path.replace(".", "_{}.".format(i)), textureMap)
            print("Saved output to {}".format(output_path.replace(".", "_{}.".format(i))))
